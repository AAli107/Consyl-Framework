...
public:
    ...
    GameObject* spawnObject(std::string name, Vec3 position);
    GameObject* spawnObject(std::string name, Vec3 position, Vec3 scale);
    GameObject* spawnObject(std::string name, Transform transform);
    bool despawnObject(std::string name);
