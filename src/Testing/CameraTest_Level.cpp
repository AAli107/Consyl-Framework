...
void CameraTest_Level::render(GameLoop &gl, Gfx &gfx) // Runs after right after update() for graphics rendering
{
    ...
    gfx.drawCircle(15, -15, 6, AsciiPixel('+', "#ff0000"), AsciiPixel('-', "#0000ff"), false);
    gfx.drawTri(20, 20, 30, 20, 25, 10, AsciiPixel('+', "#ff0000"), AsciiPixel('-', "#0000ff"), false);
    gfx.drawQuad(-20, 10, -30, 10, -30, 0, -20, 0, AsciiPixel('+', "#ff0000"), AsciiPixel('-', "#0000ff"), false);
