...
void CameraTest_Level::render(GameLoop &gl, Gfx &gfx) // Runs after right after update() for graphics rendering
{
    ...
    gfx.drawCircle(15, -15, 6, AsciiPixel('+', Color(255, 0, 0)), AsciiPixel('-', Color(0, 0, 255)), false);
    gfx.drawTri(20, 20, 30, 20, 25, 10, AsciiPixel('+', Color(255, 0, 0)), AsciiPixel('-', Color(0, 0, 255)), false);
    gfx.drawQuad(-20, 10, -30, 10, -30, 0, -20, 0, AsciiPixel('+', Color(255, 0, 0)), AsciiPixel('-', Color(0, 0, 255)), false);
